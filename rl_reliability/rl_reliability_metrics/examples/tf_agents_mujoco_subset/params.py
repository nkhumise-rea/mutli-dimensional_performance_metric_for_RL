...
data_source = 'csv' #'tensorboard' to load the Tensorboard example data
algos = ['sac','ddpg','td3']
tasks = ['reach'] #, 'push', 'slide']

#suboptimal_15Nov
# n_runs_per_experiment = 10 #11
# runs = ['1','3','4','5','6','7','8','9','10','11'] #,'2' excluded

#vetted_15NOv
runs = ['1','2','3','4','5','6']
n_runs_per_experiment = 6


# Base directory for data and results.
home = os.path.expanduser('~')
base_dir = os.path.join(home, 'rl-reliability-metrics/rl_reliability_metrics/tf_agents_mujoco_expts')
...
n_random_samples = 1200  # Normally this should be >= 1000
n_worker = 1
